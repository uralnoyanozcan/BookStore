...
namespace BookStore.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult CreateAd()
        {
            ...
            ViewBag.categorylist = new SelectList(li, "cat_init", "cat_name");
        ...
        public ActionResult ViewAd(int ?id)
        {
            ...
            ad.pro_author = p.pro_author;
            tbl_category cat = db.tbl_category.Where(x => x.cat_init == p.pro_fk_cat).SingleOrDefault();
